...
export const ALPHABET_DATA: AlphabetEntry[] = [
  ...
  { letter: "H h", upperLower: "H h", sampleWord: "hayi / ha-a", meaning: "nest / banana", initial: "habon (soap), hepey (narrow), hi-il (bamboo floor), hobol (spring)", initialMeaning: "soap / narrow / bamboo floor", middle: "ahin (salt), ehad (upland plant), ahe (no), paliyan (field)", middleMeaning: "salt / no / field", final: "balah (river), peh-peh (lemon), palih (rice plant)", finalMeaning: "river / lemon / rice plant", note: "Softer and more breathy than the English h — easy to miss when listening, so listen closely between vowels (as in ahe, ahin)." },
